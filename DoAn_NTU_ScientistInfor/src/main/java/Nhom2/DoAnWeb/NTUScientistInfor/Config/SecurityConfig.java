    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/quanlykhoahoc/trangchu", "/quanlykhoahoc/baibaokhoahoc", "/quanlykhoahoc/baibaokhoahoc/chitiet/**","/quanlykhoahoc/nhakhoahoc", "/quanlykhoahoc/nkh/{nkhId}/detail", "/image/**", "/images/**", "/css/**", "/js/**", "/baibaokhoahoc.css").permitAll()
